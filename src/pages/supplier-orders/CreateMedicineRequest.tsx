              ...
              <div className="flex items-stretch gap-0">
                ...
                {selectedSupplier && (
                  <div className="flex-1 flex flex-col justify-center pr-3 min-w-[180px]">
                    ...
                    {selectedSupplier.contact && <p className="text-[11px] text-muted-foreground mt-0.5 flex items-center gap-1"><Phone className="h-3.5 w-3.5 text-icon-phone" /> {selectedSupplier.contact}</p>}
                    {selectedSupplier.email && <p className="text-[11px] text-muted-foreground flex items-center gap-1"><Mail className="h-3.5 w-3.5 text-icon-mail" /> {selectedSupplier.email}</p>}
