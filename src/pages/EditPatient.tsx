	...
	useEffect(() => {
		if (patientData) {
			setDemographic({
				...
				state: patientData.address?.stateId !== undefined && patientData.address?.stateId !== null ? String(patientData.address.stateId) : '',
				district: patientData.address?.districtId !== undefined && patientData.address?.districtId !== null ? String(patientData.address.districtId) : '',
				mandal: patientData.address?.mandalId !== undefined && patientData.address?.mandalId !== null ? String(patientData.address.mandalId) : '',
						...
						return (
							<DashboardLayout>
								<div className="space-y-4">
									...
									<div>
										{currentStep === 1 && (
											<DemographicStep data={demographic} photoUrl={photoUrl} onUpdate={updateDemographic} onPhotoChange={setPhotoUrl} />
										)}
										{currentStep === 2 && (
											<HistoryStep
												data={{
